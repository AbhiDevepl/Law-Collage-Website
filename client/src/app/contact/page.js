...
// Move to a shared config/constants file if reused elsewhere (footer, faculty page, etc.)
const phoneContacts = [
  {
    label: "Fate Sir",
    number: "+91 92707 09696",
...
export const metadata = {
  title: "Contact Us | Shri Shivajirao Nagawade Law College",
  description:
    "Get in touch with SSNLC — email, phone, and campus location at Balaji Nagar, Mandavgaon Road, Shrigonda, Ahilyanagar, Maharashtra.",
};
...
export default function ContactPage() {
  const jsonLd = {
    ...
    url: "https://ssnlc.in",
    email: "hello@ssnlc.in",
    telephone: "+91 92707 09696",
    address: {
      "@type": "PostalAddress",
      streetAddress: "Balaji Nagar, Mandavgaon Road, MH SH 55",
  ...
  return (
    <main className="relative bg-[#0a2a52] min-h-screen py-16 sm:py-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-blue-200 text-lg sm:text-xl max-w-2xl mx-auto leading-relaxed">
            Have questions? We'd love to hear from you. Reach out through any
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          <div className="lg:w-1/2 order-2 lg:order-1 flex flex-col gap-6">
            {/* Admission Enquiry — structured form, posts to /api/enquiry */}
            ...
            <div className="space-y-4">
              ...
              {phoneContacts.map((contact) => (
                <a
                  ...
                  className="group relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-5 hover:shadow-2xl hover:-translate-y-1 focus-visible:ring-4 focus-visible:ring-amber-400 transition-all duration-300 border border-white/20 block"
                >
            ...
            <a
              href="https://www.google.com/maps?q=18.61739,74.70476"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-6 hover:shadow-2xl hover:-translate-y-1 focus-visible:ring-4 focus-visible:ring-emerald-400 transition-all duration-300 border border-white/20 block"
            >
              <div className="flex items-start gap-4">
                <div className="relative flex-shrink-0">
